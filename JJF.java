...
public class JJF extends JFrame{
    ...
    JJF2 p = new JJF2(this);
    /*
     * Gestion des onglets 
     */
    private Memoires memoire = new Memoires() ;
    
    Errore err= new Errore() ;
    //COnsole du bas pour la gestion des exceptions
    JTextField jtf ;
    
    Bruitage [] brui = new Bruitage[10];
...
//	setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
	...
	//JSLIDER QUI PERMET DE CONTROLER LA VITESSE DE LINK PENDANT SON DEPLACEMENT
	...
	item6.addActionListener(new ActionListener(){
		public void actionPerformed(ActionEvent event){
		    ...
		    onglet.add(nom ,text);
		    brui[8] = new Bruitage("music/select",true);
		    brui[8].jou();
				...
				e1.printStackTrace();
				    ...
				    try {
					    ...
					    if(main.Err == ""){
							 ...
							 exe.start();
							   brui[7] = new Bruitage("music/select2",true);
								brui[7].jou();
					    }
					} catch (Exception e) {
				...
				JOptionPane az = new JOptionPane() ;
	  			int opt = az.showConfirmDialog(null ,"activer le son ?","Menu",JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
	  			 if( opt == JOptionPane.OK_OPTION){
	  				 bruitage =true;   
	  				 brui[0] = new Bruitage("music/run",true);
	  				brui[1] = new Bruitage("music/cercle",true);
	  				brui[2] = new Bruitage("music/cri",true);
	  				brui[3] = new Bruitage("music/MC_Error",true);
	  				sequencer.start() ;
	  					
	  			 }else{
	  				 bruitage=false;
	  			    brui[0] = new Bruitage("music/run",false);
	  				brui[1] = new Bruitage("music/cercle",false);
	  				brui[2] = new Bruitage("music/cri",false);
	  				brui[3] = new Bruitage("music/MC_Error",false);
	  				sequencer.stop() ;
	...
	brui[2] = new Bruitage("music/cri",false);
	brui[3] = new Bruitage("music/MC_Error",false);
	brui[4] = new Bruitage("music/fin",false);
    ...
    class Exec implements Runnable{
    	...
    	public void run() {
    		...
    		p.pincea =main.parser.av.epais ;
    		 ...
    		 brui[5] = new Bruitage("music/baspinceau",true);
    		 brui[6] = new Bruitage("music/shield",true);
